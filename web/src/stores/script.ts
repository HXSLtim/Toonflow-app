...
export const useScriptStore = create<ScriptState & ScriptActions>((set) => ({
  ...
  fetchScripts: async (projectId: number) => {
    ...
    try {
      ...
      set({ error: getErrorMessage(error, '获取脚本列表失败'), isLoading: false });
    }
  },
  ...
  fetchScript: async (id: number) => {
    ...
    try {
      ...
      set({ error: getErrorMessage(error, '获取脚本详情失败'), isLoading: false });
    }
  },
  ...
  createScript: async (data) => {
    ...
    try {
      ...
      set({ error: getErrorMessage(error, '创建脚本失败'), isLoading: false });
      throw error;
    }
  },
  ...
  updateScript: async (id: number, data) => {
    ...
    try {
      ...
      set((state) => ({
        scripts: state.scripts.map((s) => (s.id === id ? { ...s, ...updated } : s)),
        currentScript: state.currentScript?.id === id ? { ...state.currentScript, ...updated } : state.currentScript,
        isLoading: false,
      }));
    } catch (error: unknown) {
      set({ error: getErrorMessage(error, '更新脚本失败'), isLoading: false });
      throw error;
    }
  },
  ...
  deleteScript: async (id: number) => {
    ...
    try {
      ...
      set({ error: getErrorMessage(error, '删除脚本失败'), isLoading: false });
      throw error;
    }
  },
  ...
  fetchOutlines: async (projectId: number) => {
    ...
    try {
      ...
      set({ error: getErrorMessage(error, '获取大纲失败'), isLoading: false });
    }
  },
  ...
  createOutline: async (data) => {
    ...
    try {
      ...
      set({ error: getErrorMessage(error, '创建大纲失败'), isLoading: false });
      throw error;
    }
  },
  ...
  updateOutline: async (id: number, data) => {
    ...
    try {
      ...
      set({ error: getErrorMessage(error, '更新大纲失败'), isLoading: false });
      throw error;
    }
  },
  ...
  deleteOutline: async (id: number) => {
    set({ isLoading: true, error: null });
    try {
      const currentOutline = useScriptStore.getState().outlines.find((outline) => outline.id === id);
      const projectId = currentOutline?.projectId;

      if (!projectId) {
        throw new Error(`删除大纲缺少 projectId（outlineId=${id}）`);
      }

      await scriptService.deleteOutlineWithProject(id, projectId);
      set((state) => ({
        outlines: state.outlines.filter((o) => o.id !== id),
        isLoading: false,
      }));
    } catch (error: unknown) {
      set({ error: getErrorMessage(error, '删除大纲失败'), isLoading: false });
      throw error;
    }
  },
  ...
  fetchNovels: async (projectId: number) => {
    ...
    try {
      ...
      set({ error: getErrorMessage(error, '获取原文失败'), isLoading: false });
    }
  },
  ...
  createNovel: async (data) => {
    ...
    try {
      ...
      set({ error: getErrorMessage(error, '创建原文失败'), isLoading: false });
      throw error;
    }
  },
  ...
  updateNovel: async (id: number, data) => {
    ...
    try {
      ...
      set({ error: getErrorMessage(error, '更新原文失败'), isLoading: false });
      throw error;
    }
  },
  ...
  deleteNovel: async (id: number) => {
    ...
    try {
      ...
      set({ error: getErrorMessage(error, '删除原文失败'), isLoading: false });
      throw error;
    }
  },
  ...
  fetchStorylines: async (projectId: number) => {
    ...
    try {
      ...
      set({ error: getErrorMessage(error, '获取故事线失败'), isLoading: false });
    }
  },
  ...
  createStoryline: async (data) => {
    ...
    try {
      ...
      set({ error: getErrorMessage(error, '创建故事线失败'), isLoading: false });
      throw error;
    }
  },
  ...
  updateStoryline: async (id: number, data) => {
    ...
    try {
      ...
      set({ error: getErrorMessage(error, '更新故事线失败'), isLoading: false });
      throw error;
    }
  },
  ...
  deleteStoryline: async (id: number) => {
    ...
    try {
      ...
      set({ error: getErrorMessage(error, '删除故事线失败'), isLoading: false });
      throw error;
    }
  },
